    ...
    public class ProfilesPageViewModel : BaseViewModel
    {
        ...
        public int SelectedPresetIndexDC
        {
            ...
            set
            {
                ...
                if (value != _selectedPresetIndexDC && value >= 0 && value < ProfilePickerCollectionViewDC.Count)
                {
                    ...
                    // get the power profile view model
                    var profilesPickerViewModel = ProfilePickerCollectionViewDC.GetItemAt(_selectedPresetIndexDC) as ProfilesPickerViewModel;
        ...
        public int SelectedPresetIndexAC
        {
            ...
            set
            {
                ...
                if (value != _selectedPresetIndexAC && value >= 0 && value < ProfilePickerCollectionViewAC.Count)
                {
                    ...
                    // get the power profile view model
                    var profilesPickerViewModel = ProfilePickerCollectionViewAC.GetItemAt(_selectedPresetIndexAC) as ProfilesPickerViewModel;
        ...
        private void QueryPowerProfile()
        {
            ...
            UIHelper.TryInvoke(() =>
            {
                ...
                SelectedPresetIndexDC = ProfilePickerCollectionViewDC.IndexOf(_profilePickerItemsDC.FirstOrDefault(a => a.LinkedPresetId == Guid.Empty));
            });
        }
        ...
        {
            var foundWindow = ProfileWindows.FirstOrDefault(win => win.ProcessWindow.Hwnd == processWindow.Hwnd);
