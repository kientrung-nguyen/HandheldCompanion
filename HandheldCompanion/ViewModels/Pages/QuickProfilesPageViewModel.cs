...
namespace HandheldCompanion.ViewModels
{
    public class QuickProfilesPageViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<ProfilesPickerViewModel> _profilePickerItemsDC = [];
        ...
        public PowerProfile SelectedPresetDC
        {
            ...
            set
            {
                if (_selectedPresetDC != value)
                {
                    ...
                    var profilesPickerViewModel = _profilePickerItemsDC.First(p => p.LinkedPresetId == _selectedPresetDC.Guid);
        ...
        public int SelectedPresetIndexDC
        {
            ...
            set
            {
                ...
                if (value != _selectedPresetIndexDC && value >= 0 && value < ProfilePickerCollectionViewDC.Count)
                {
                    ...
                    // get the power profile view model
                    var profilesPickerViewModel = (ProfilesPickerViewModel)ProfilePickerCollectionViewDC.GetItemAt(_selectedPresetIndexDC);
                    SelectedPresetDC = ManagerFactory.powerProfileManager.GetProfile(profilesPickerViewModel.LinkedPresetId ?? PowerProfile.DefaultDC, PowerLineStatus.Offline);
        ...
        public PowerProfile SelectedPresetAC
        {
            ...
            set
            {
                if (_selectedPresetAC != value)
                {
                    ...
                    // get the power profile view model
                    var profilesPickerViewModel = _profilePickerItems.First(p => p.LinkedPresetId == _selectedPresetAC.Guid);
        ...
        public int SelectedPresetIndexAC
        {
            ...
            set
            {
                ...
                if (value != _selectedPresetIndexAC && value >= 0 && value < ProfilePickerCollectionViewAC.Count)
                {
                    ...
                    // get the power profile view model
                    var profilesPickerViewModel = (ProfilesPickerViewModel)ProfilePickerCollectionViewAC.GetItemAt(_selectedPresetIndexAC);
                    SelectedPresetAC = ManagerFactory.powerProfileManager.GetProfile(profilesPickerViewModel.LinkedPresetId ?? PowerProfile.DefaultAC, PowerLineStatus.Online);
        ...
        public QuickProfilesPageViewModel(QuickProfilesPage quickProfilesPage)
        {
            ...
            BindingOperations.EnableCollectionSynchronization(_profilePickerItemsDC, new object());
            ...
            ProfilePickerCollectionViewDC = new ListCollectionView(_profilePickerItemsDC);
        ...
        private void QueryPowerProfile()
        {
            ...
            UIHelper.TryInvoke(() =>
            {
                ...
                SelectedPresetIndexAC = ProfilePickerCollectionViewAC.IndexOf(_profilePickerItems.FirstOrDefault(a => a.LinkedPresetId == PowerProfile.DefaultAC));
                SelectedPresetIndexDC = ProfilePickerCollectionViewDC.IndexOf(_profilePickerItemsDC.FirstOrDefault(a => a.LinkedPresetId == PowerProfile.DefaultDC));
            });
        }
        ...
        private void PowerProfileManager_Deleted(PowerProfile profile)
        {
            ...
            {
                var foundPreset = _profilePickerItems.FirstOrDefault(p => p.LinkedPresetId == profile.Guid)
                    ?? _profilePickerItemsDC.FirstOrDefault(p => p.LinkedPresetId == profile.Guid);
                if (foundPreset is not null)
                {
                    _profilePickerItems.Remove(foundPreset);
                    _profilePickerItemsDC.Remove(foundPreset);
        ...
        private void PowerProfileManager_Updated(PowerProfile profile, UpdateSource source)
        {
            lock (ProfilePickerLock)
            {
                ...
                if (foundPreset is not null)
                {
                    ...
                    if (index == -1)
                        index = _profilePickerItemsDC.IndexOf(foundPreset);
                ...
                {
                    index = 0;
                    if (profile.Guid == PowerProfile.DefaultAC || profile.Guid == PowerProfile.DefaultDC)
                    {
                        if (profile.Guid == PowerProfile.DefaultAC)
                        ...
                        if (profile.Guid == PowerProfile.DefaultDC)
                            _profilePickerItemsDC.Insert(index, new() { LinkedPresetId = profile.Guid, Text = profile.Name, IsInternal = profile.IsDefault() || profile.IsDeviceDefault() });
                        return;
                    }
        ...
        public void PowerProfileChanged(PowerProfile powerProfileAC, PowerProfile powerProfileDC)
        {
            lock (ProfilePickerLock)
            {
                UIHelper.TryInvoke(() =>
                {
                    ...
                    SelectedPresetIndexDC = ProfilePickerCollectionViewDC.IndexOf(_profilePickerItemsDC.FirstOrDefault(a => a.LinkedPresetId == powerProfileDC.Guid));
                });
            }
        }
