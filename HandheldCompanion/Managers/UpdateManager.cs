...
namespace HandheldCompanion.Managers
{
    public static class UpdateManager
    {
        ...
        public static void Start()
        {
            ...
            lastCheck = ManagerFactory.settingsManager.Get<DateTime>("UpdateLastChecked");
        ...
        private static void QuerySettings()
        {
            ...
            SettingsManager_SettingValueChanged("UpdateUrl", ManagerFactory.settingsManager.Get<string>("UpdateUrl"), false);
        }
        ...
        private static void UpdateTime()
        {
            ...
            ManagerFactory.settingsManager.Set("UpdateLastChecked", lastCheck);
        }
