...
public static class UpdateManager
{
    ...
    public static async Task Start()
    {
        ...
        DateTime dateTime = SettingsManager.Get<DateTime>("UpdateLastChecked");
        ...
        {
            SettingsManager_SettingValueChanged("UpdateUrl", SettingsManager.Get<string>("UpdateUrl"), false);
        }
    ...
    private static void UpdateTime()
    {
        ...
        SettingsManager.Set("UpdateLastChecked", lastCheck);
    }
