...
public static class DynamicLightingManager
{
    ...
    private static LEDLevel LEDSettingsLevel => (LEDLevel)ManagerFactory.settingsManager.Get<int>("LEDSettingsLevel");
    private static int LEDBrightness => ManagerFactory.settingsManager.Get<int>("LEDBrightness");
    private static int LEDSpeed => ManagerFactory.settingsManager.Get<int>("LEDSpeed");
    private static Color LEDMainColor => ManagerFactory.settingsManager.Get<Color>("LEDMainColor");
    private static Color LEDSecondColor => ManagerFactory.settingsManager.Get<Color>("LEDSecondColor");
    private static bool useSecondColor => ManagerFactory.settingsManager.Get<bool>("LEDUseSecondColor");
    private static int LEDPresetIndex => ManagerFactory.settingsManager.Get<int>("LEDPresetIndex");
