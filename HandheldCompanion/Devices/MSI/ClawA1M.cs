...
public class ClawA1M : IDevice
{
    ...
    {
        // raise events
        SettingsManager_SettingValueChanged("MSIClawControllerIndex", ManagerFactory.settingsManager.Get<int>("MSIClawControllerIndex"), false);
        SettingsManager_SettingValueChanged("BatteryChargeLimit", ManagerFactory.settingsManager.Get<int>("BatteryChargeLimit"), false);
        SettingsManager_SettingValueChanged("BatteryChargeLimitPercent", ManagerFactory.settingsManager.Get<int>("BatteryChargeLimitPercent"), false);
