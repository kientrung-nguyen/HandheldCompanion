...
public class NeptuneController : SteamController
{
    ...
    public override void Unhide(bool powerCycle = true)
    {
        ...
        var isExclusiveMode = ManagerFactory.settingsManager.Get<bool>("SteamControllerMode");
        if (isExclusiveMode)
            return;
    ...
    private void QuerySettings()
    {
        ...
        // raise events
        SettingsManager_SettingValueChanged("SteamControllerRumbleInterval", ManagerFactory.settingsManager.Get<int>("SteamControllerRumbleInterval"), false);
    }
