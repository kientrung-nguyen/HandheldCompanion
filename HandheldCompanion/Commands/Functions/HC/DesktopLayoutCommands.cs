...
namespace HandheldCompanion.Commands.Functions.HC
{
    ...
    public class DesktopLayoutCommands : FunctionCommands
    {
        ...
        private void SettingsManager_SettingValueChanged(string name, object value, bool temporary)
        {
            switch (name)
            {
                case SettingsName:
                    ...
                    LayoutModes LayoutMode = (LayoutModes)ManagerFactory.settingsManager.Get<int>(SettingsName);
        ...
        private void ExecuteTimer_Elapsed(object? sender, ElapsedEventArgs e)
        {
            ...
            int value = ManagerFactory.settingsManager.Get<int>(SettingsName);
            ...
            // Update settings
            ManagerFactory.settingsManager.Set(SettingsName, (int)layoutMode);
        ...
        public override void Execute(bool IsKeyDown, bool IsKeyUp, bool IsBackground)
        {
            if (ExecuteTimer.Enabled)
            {
                ...
                // Update settings
                ManagerFactory.settingsManager.Set(SettingsName, (int)LayoutModes.Auto);
